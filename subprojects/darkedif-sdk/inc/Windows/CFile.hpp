...
_NODISCARD FusionAPIImport _Success_(return != HFILE_ERROR) _Must_inspect_result_
...
_NODISCARD FusionAPIImport _Success_(return >= 0) _Must_inspect_result_
...
_NODISCARD FusionAPIImport Fusion64APISwitch("Use File_GetLength_Ex") _Success_(return >= 0) _Must_inspect_result_
...
_NODISCARD FusionAPIImport _Must_inspect_result_
...
_NODISCARD FusionAPIImport _Ret_range_(0, INT64_MAX) _Must_inspect_result_
...
public:
	...
	// TODO: Confirm NULL or INVALID_HANDLE_VALUE.
	_NODISCARD virtual _Must_inspect_result_
		HANDLE Detach() = 0;

	// Reads a section of the file. The memory is const!
	_NODISCARD virtual _Success_(return != nullptr) _Must_inspect_result_ _Ret_bytecount_(nSize)
...
public:
	...
	_NODISCARD virtual _Success_(return >= 0) _Must_inspect_result_
...
public:
	...
	_NODISCARD _Ret_maybenull_ _Must_inspect_result_

...
// acecalltablegen <Extension.cpp path> <Extension.hpp path> <output ACECallTable_Macro.cpp>
...
int main(int argc, char const *argv[]) {
    ...
    // Use the template to create the output
    {
        ...
        out << "#if DARKEDIF_ACE_CALL_TABLE_INDEX==0\n";
        std::string indent = "    ";
        ...
        out << "#elif DARKEDIF_ACE_CALL_TABLE_INDEX==1\n";
        ...
        out << "#elif DARKEDIF_ACE_CALL_TABLE_INDEX==2\n";
        ...
        out << "#else\n";
        out << "#error Incorrect DarkEdif ACE Call Table index\n";
        out << "#endif\n";
    }
